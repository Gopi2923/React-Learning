...
## Episode 04
  ...
  ## Creating food app, props, map method

- Props is end of the day it's a passing argument to functions
- whenever we passing the dynamic data send as a props
- we can pass any no of props, react will wrap all of them as a object pass it over.
- Config driven UI
- map, while mapping key is important
- don't use index in react, it's recommonded
